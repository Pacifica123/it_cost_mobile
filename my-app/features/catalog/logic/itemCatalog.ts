...
export type CatalogItemType = 'hardware' | 'software' | 'operating';

export type TypicalCatalogItem = {
  id: string;
...
export const typicalCatalogItems: TypicalCatalogItem[] = [
  {
...
export const catalogItemToCapital = (item: TypicalCatalogItem): CapitalEquipment => ({
...
export const catalogItemToOperating = (item: TypicalCatalogItem): OperatingEquipment => ({
...
export const filterCatalogItems = (items: TypicalCatalogItem[], query: string, type: CatalogItemType | 'all') => {
