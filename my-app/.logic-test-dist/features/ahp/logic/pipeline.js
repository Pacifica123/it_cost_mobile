...
exports.runAHPipeline = runAHPipeline;
const constants_1 = require("../constants");
Object.defineProperty(exports, "DEFAULT_SOFT_CRITERIA", { enumerable: true, get: function () { return constants_1.DEFAULT_SOFT_CRITERIA; } });
Object.defineProperty(exports, "M1", { enumerable: true, get: function () { return constants_1.M1; } });
Object.defineProperty(exports, "M2", { enumerable: true, get: function () { return constants_1.M2; } });
function centroid(r) {
...
function runAHPipeline({ configurations, softCriteria, experts, constraints, }) {
    ...
    const passed = aggregates.filter((aggregate) => aggregate.total_cost <= constraints.max_budget &&
    ...
    const warning = passed.length === 0
        ...
        : undefined;
    const scores = passed.map((aggregate) => softCriteria.map((criterion) => aggregate[criterion] ?? 0));
    const weights = normalize(softCriteria.map((_, index) => scores.reduce((sum, row) => sum + (row[index] || 0), 0)));
