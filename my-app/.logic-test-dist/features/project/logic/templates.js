...
exports.findProjectTemplate = exports.projectTemplates = void 0;
const defaults_1 = require("../../../store/data/defaults");
const catalogRules_1 = require("../../../store/data/catalogRules");
const buildTemplateState = (_id, patch) => ({
    ...
    redoStack: [],
    projectEvents: [
        (0, defaults_1.createProjectEvent)('Применён шаблон', `Шаблон: ${patch.projectMeta.name}.`, 'template', patch.projectMeta.updatedAt),
    ],
});
exports.projectTemplates = [
    {
        ...
        state: buildTemplateState('office-basic', {
            projectMeta: (0, defaults_1.createDefaultProjectMeta)({
            ...
            appSettings: defaults_1.defaultAppSettings,
            exchangeRates: defaults_1.defaultExchangeRates,
            categories: defaults_1.initialCategories,
            capitalData: (0, catalogRules_1.ensureCapitalKinds)([
...
const findProjectTemplate = (id) => exports.projectTemplates.find((template) => template.id === id);
exports.findProjectTemplate = findProjectTemplate;
