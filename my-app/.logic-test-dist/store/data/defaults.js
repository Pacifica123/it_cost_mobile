...
const createProjectEvent = (title, description = '', type = 'project', createdAt = now) => ({
...
const makeProjectSnapshot = (state) => ({
...
exports.makeProjectSnapshot = makeProjectSnapshot;
exports.initialState = {
    schemaVersion: exports.CURRENT_DATA_SCHEMA_VERSION,
    projectMeta: (0, exports.createDefaultProjectMeta)({
    ...
    appSettings: exports.defaultAppSettings,
    exchangeRates: exports.defaultExchangeRates,
    projectEvents: [
        (0, exports.createProjectEvent)('Создан демо-проект', 'Загружены стартовые категории и демонстрационные позиции.', 'template'),
    ],
    ...
    categories: exports.initialCategories,
    electricityTotal: 0,
};
exports.emptyProjectState = {
    ...
    exchangeRates: exports.defaultExchangeRates,
    projectEvents: [
        (0, exports.createProjectEvent)('Создан пустой проект', 'Позиции очищены, базовые категории сохранены.', 'reset'),
    ],
    activeProjectId: null,
    savedProjects: [],
    projectBackups: [],
